# =============================================================================
#  JORDAN AVIATION — AVIATION SMS ENTERPRISE REPORTING ENGINE
...
class _AviaHeader:
    ...
    def __call__(self, canvas, doc):
        ...
        canvas.drawString(MARGIN, h - 10 * mm, 'JORDAN AVIATION')
        ...
        canvas.drawString(MARGIN, 4.5 * mm,
                          'This document is a controlled record of the Jordan Aviation '
...
def _build_doc(flowables, doc_type, control_number, classification,
    ...
    doc = SimpleDocTemplate(
        ...
        author='Jordan Aviation SMS',
        subject='ICAO Annex 19 Controlled Document',
        creator='Jordan Aviation SMS v1.0',
    )
...
def pdf_risk_assessment(ra, hazard, rows, mitigations, reviews,
    ...
    """Risk Assessment PDF — mirrors Jordan Aviation RA Form pages 1-5."""
    S = _styles()
...
def pdf_voluntary(report, generated_by='Safety Department'):
    ...
    E.append(Paragraph(
        ...
        'in accordance with Jordan Aviation SMS procedures. Reporter confidentiality '
...
def pdf_spi_summary(indicators, data_by_spi, generated_by='Safety Department'):
    ...
    E.append(Spacer(1, 8))
    E.append(Paragraph(
        'This SPI Summary Report is produced automatically from the Jordan Aviation '
